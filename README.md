...
##### 효율적인 방법이 도저히 생각나지 않아서 단순하게 1층~꼭대기층을 왔다갔다하는 코드를 짰다.
##### 코드의 naive함을 엘리베이터 4대를 독립적으로 운용함으로써 그나마 극복했다.

#### Efficiency : Q1: 29 timestamps , Q2: 632 timestamps , Q3: 1893 timestamps

##### C++을 이용했다면 각각 엘리베이터 내에 우선순위 큐, set을 두어 조금 더 효율적인 코드를 작성할 수 있었을텐데, 파이썬으로 문제를 푸는 것이 익숙지 않아 구현에 어려움이 있었다
